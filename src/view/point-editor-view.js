...
import { EVENT_TYPES, CITIES, DateFormat, EditType, REQUIRED_BASE_POINT_FIELDS } from '../const.js';
...
export default class PointEditorView extends AbstractStatefulView {
  ...
  #validatePoint = () => REQUIRED_BASE_POINT_FIELDS.every((field) => !!this._state[field]);
